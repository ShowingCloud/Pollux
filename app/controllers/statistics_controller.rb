class StatisticsController < ApplicationController
  ...
  private
    ...
    def statistic_params
      params.require(:statistic).permit(:stat_time, :round_ant, :round_btc, :round_trans, :round_avg_btc, :round_accounts, :round_rate, :total_ant, :total_btc, :total_trans, :total_avg_btc, :total_accounts, :total_rate)
    end
end
